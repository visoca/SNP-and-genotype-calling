...
## Table of contents
1. [SNP and genotype calling with BCFtools](bcftools.md)
2. [VCF and BCF format](vcfbcf.md)
3. [SNP and genotype calling with GATK](gatk.md)
4. [Operations with BCF files](bcfops.md)
